<%@page session="false" contentType="text/html" pageEncoding="UTF-8" 
	import="
		${packageName}.Edit${className}ModelBean,
...
Locale locale = (Locale) request.getAttribute(PersonCrudPortlet.LOCALE_KEY);
String saveActionURL = request.getAttribute(PersonCrudPortlet.SAVE_ACTION_KEY).toString();
String resetActionURL = request.getAttribute(PersonCrudPortlet.RESET_ACTION_KEY).toString();

String flexFileName = request.getContextPath() + "/${entityName}/edit.swf" + 
...
<script language="javascript" >
	function resizeContainer(height) {
		var div = document.getElementById("${entityName}EditSwfWrapper");
		div.style.height = height + "px";
	}
</script>

<div id="${entityName}EditSwfWrapper" style="overflow: auto; overflow-y:hidden">
	<object 
		border="none"
