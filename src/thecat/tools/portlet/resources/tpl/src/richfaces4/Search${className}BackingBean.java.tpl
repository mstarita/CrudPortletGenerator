...
<#list fieldList as field>		
		searchModelBean.getSearch${className}().set${field.fieldName?cap_first}(null);
</#list>
...
<#list fieldList as field>
	public void sortBy${field.fieldName?cap_first}() {
	
	<#list fieldList as sortField>
		<#if field != sortField>
		searchModelBean.set${sortField.fieldName?cap_first}Order(SortOrder.unsorted);
		</#if>
	</#list>
	
		if (searchModelBean.get${field.fieldName?cap_first}Order().equals(SortOrder.ascending)) {
			searchModelBean.set${field.fieldName?cap_first}Order(SortOrder.descending);
		} else {
			searchModelBean.set${field.fieldName?cap_first}Order(SortOrder.ascending);
		}
		
		System.out.println("sortBy${field.fieldName?cap_first} fired!!!");
	}
