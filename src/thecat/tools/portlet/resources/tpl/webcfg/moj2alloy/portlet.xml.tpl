...
<portlet-app xmlns="http://java.sun.com/xml/ns/portlet/portlet-app_2_0.xsd" version="2.0"
        ...
        <portlet>
                ...
                <display-name>Mojarra 2 + Liferay Alloy ${className} CRUD Portlet</display-name>
                ...
                <portlet-info>
                        <title>Mojarra 2 + Liferay Alloy ${className} CRUD Portlet</title>
                        <short-title>moj2alloy${className}Crud</short-title>
                </portlet-info>
